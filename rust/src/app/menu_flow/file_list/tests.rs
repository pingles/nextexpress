...
async fn zippy_inline_query_dumps_the_matching_block_in_the_chosen_dir() {
    ...
    let services = services_with_demo_catalogue();
    let mut terminal = CaptureTerminal::new(vec![TerminalRead::Line("1".to_string())]);
    run_zippy(
        &services,
        &mut terminal,
...
async fn zippy_all_directories_answer_walks_every_area() {
    ...
    let services = services_with_demo_catalogue();
    let mut terminal = CaptureTerminal::new(vec![TerminalRead::Line("A".to_string())]);
    run_zippy(
        &services,
        &mut terminal,
...
async fn zippy_upload_answer_scans_the_highest_directory() {
    ...
    let services = services_with_demo_catalogue();
    let mut terminal = CaptureTerminal::new(vec![TerminalRead::Line("U".to_string())]);
    run_zippy(
        &services,
        &mut terminal,
...
async fn zippy_hold_answer_scans_the_empty_hold_directory() {
    ...
    let services = services_with_demo_catalogue();
    let mut terminal = CaptureTerminal::new(vec![TerminalRead::Line("H".to_string())]);
    run_zippy(
        &services,
        &mut terminal,
        ZippyArg::Query("DEMO".to_string()),
...
async fn zippy_out_of_range_directory_reports_no_such_directory() {
    ...
    let services = services_with_demo_catalogue();
    let mut terminal = CaptureTerminal::new(vec![TerminalRead::Line("5".to_string())]);
    run_zippy(
        &services,
        &mut terminal,
        ZippyArg::Query("DEMO".to_string()),
...
async fn zippy_highest_dir_number_is_in_range_and_scans() {
    ...
    let services = services_with_demo_catalogue();
    let mut terminal = CaptureTerminal::new(vec![TerminalRead::Line("2".to_string())]);
    run_zippy(
        &services,
        &mut terminal,
        ZippyArg::Query("DEMO".to_string()),
...
async fn zippy_zero_directory_is_out_of_range() {
    ...
    // some "dir 0".
    let services = services_with_demo_catalogue();
    let mut terminal = CaptureTerminal::new(vec![TerminalRead::Line("0".to_string())]);
    run_zippy(
        &services,
        &mut terminal,
        ZippyArg::Query("DEMO".to_string()),
