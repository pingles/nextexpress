...
- **In Scope**
  ...
  - `core.allium:ConferenceMembership` entity with `granted` and message-counter fields actually consumed by Phase 5; ratio fields and per-conf byte tallies land with their slices (61).
